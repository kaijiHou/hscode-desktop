...
export const dict = {
  ...
  "desktop.menu.networkCaptureGuide": "網路抓包使用手冊",
  ...
  "desktop.recovery.loadFailed": "HSCode 載入失敗",
  "desktop.recovery.terminated": "HSCode 視窗意外終止",
  "desktop.recovery.unresponsive": "HSCode 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "HSCode 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.opencodeMissing": "此發行版中未安裝 HSCode",
  "desktop.wsl.error.opencodeCannotRun": "已安裝 HSCode，但無法執行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 HSCode",
  "desktop.wsl.error.updateVersion":
    "HSCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "HSCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 HSCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 HSCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 HSCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 HSCode 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 HSCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 HSCode...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 HSCode 已就緒。",
  "wsl.onboarding.opencodeReady": "HSCode 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 HSCode。",
  "wsl.onboarding.installOpencode": "安裝 HSCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 HSCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "HSCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 HSCode。",
  ...
  "help.tabs.introduction": "HSCode Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "HSCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：HSCode 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "HSCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 HSCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 HSCode 的顯示語言",
  ...
  "settings.general.row.colorScheme.description": "選擇 HSCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 HSCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 HSCode 啟動時自動檢查更新",
