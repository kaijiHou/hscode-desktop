...
export const dict = {
  ...
  "command.network.toggle": "Network Capture",
  ...
  "dialog.model.manage": "Custom Model",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in HSCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in HSCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in HSCode.",
  ...
  "dialog.server.description": "Switch which HSCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking HSCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking HSCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating HSCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating HSCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update HSCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update HSCode",
  "wsl.onboarding.opencodeReadyIn": "HSCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "HSCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install HSCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install HSCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HSCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before HSCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "HSCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen HSCode.",
  ...
  "help.tabs.introduction": "HSCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of HSCode ({{version}}) is now available to install.",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, HSCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "HSCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the HSCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for HSCode",
  ...
  "settings.general.row.colorScheme.description": "Choose whether HSCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how HSCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when HSCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of HSCode.",
