...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "HSCode 加载失败",
  "desktop.recovery.terminated": "HSCode 窗口意外终止",
  "desktop.recovery.unresponsive": "HSCode 未响应",
  ...
  "desktop.wsl.error.installOpencode": "HSCode 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 HSCode",
  "desktop.wsl.error.updateVersion":
    "HSCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 HSCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 HSCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 HSCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 HSCode 服务器。",
  ...
  "wsl.onboarding.step.opencode": "HSCode",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 HSCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 HSCode...",
  "wsl.onboarding.updatingOpencode": "正在更新 HSCode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 HSCode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 HSCode。",
  "wsl.onboarding.updateOpencode": "更新 HSCode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 HSCode 已就绪。",
  "wsl.onboarding.opencodeReady": "HSCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 HSCode。",
  "wsl.onboarding.installOpencode": "安装 HSCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 HSCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "HSCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "HSCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 HSCode。",
  ...
  "help.tabs.introduction": "HSCode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "HSCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：HSCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "HSCode 提供免费模型，你可以立即开始使用。",
  ...
  "app.name.desktop": "HSCode Desktop",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 HSCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 HSCode 的显示语言",
  ...
  "settings.general.row.shell.switchToPwsh": "切换到 PowerShell 7",
  ...
  "settings.general.row.colorScheme.description": "选择 HSCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 HSCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 HSCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 HSCode。",
